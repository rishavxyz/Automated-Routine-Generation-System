...
def resourcePrefUpdate(no_slots_per_day, pref_file=None,data_file=None,key_field=None):
    ...
    for tuple in pref_df.itertuples():
        ...
        try:
            off_slots = [int(float(i))-1 for i in list(map(str.strip,str(tuple.MONDAY_OFF_SLOTS).split(','))) if not int(float(i))-1<0]
        ...
        try:
            off_slots = [int(float(i))-1 for i in list(map(str.strip,str(tuple.TUESDAY_OFF_SLOTS).split(','))) if not int(float(i))-1<0]
        ...
        try:
            off_slots = [int(float(i))-1 for i in list(map(str.strip,str(tuple.WEDNESDAY_OFF_SLOTS).split(','))) if not int(float(i))-1<0]
        ...
        try:
            off_slots = [int(float(i))-1 for i in list(map(str.strip,str(tuple.THURSDAY_OFF_SLOTS).split(','))) if not int(float(i))-1<0]
        ...
        try:
            off_slots = [int(float(i))-1 for i in list(map(str.strip,str(tuple.FRIDAY_OFF_SLOTS).split(','))) if not int(float(i))-1<0]
        ...
        try:
            off_slots = [int(float(i))-1 for i in list(map(str.strip,str(tuple.SATURDAY_OFF_SLOTS).split(','))) if not int(float(i))-1<0]
        ...
        try:
            off_slots = [int(float(i))-1 for i in list(map(str.strip,str(tuple.SUNDAY_OFF_SLOTS).split(','))) if not int(float(i))-1<0]
        ...
        try:
            off_slots = [int(float(i)) - 1 for i in list(map(str.strip,str(tuple.GENERAL_OFF_SLOTS).split(','))) if not int(float(i)) - 1 < 0]
        ...
        try:
            off_day_list=list(map(str.strip,str(tuple.OFF_DAYS).split(',')))
            print(off_day_list)
